...
GroupNetworkBoot <- function(
   ...
   # network_args = as.data.frame(groupNetwork$miscellaneous)
   # network_args$arg = row.names(network_args)
   # colnames(network_args)[1] = "setting"
   # network_args = mutate_all(network_args, as.character)
